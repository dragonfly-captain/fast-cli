...
const {getclipath} = require("../../common/utils");
...
module.exports = {
  ...
  */
  ...
  // 这里可以根据自己的需求针对 react 进行配置
    // "react/prop-types": !isProduction ? 0 : 2,  // prop-types 检查
    // "react/prefer-hooks": 1 // 建议使用Hook
  },
  settings: {
    react: {
      // version: require(pathJoin('package.json', getclipath('.')))
      version:'detect'
    }
  },
  // 针对 LESS 文件的配置
